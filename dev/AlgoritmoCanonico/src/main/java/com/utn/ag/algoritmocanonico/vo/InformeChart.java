...
public class InformeChart extends ArrayList<InformeVO> {
	...
	protected void createDataset() {
		...
		for (InformeVO informe : this) {
			minSeries.add(i, informe.getMin().getFunctionValue());
			maxSeries.add(i, informe.getMax().getFunctionValue());
	...
	protected void createChart() {
		chart = ChartFactory.createXYLineChart("Grafico", // chart title
				"x", // domain axis label
